...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/deep2essence/planet/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/deep2essence/planet/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/deep2essence/planet/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/deep2essence/planet/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/deep2essence/planet/blog/sent_post
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/deep2essence/planet/blog/sent_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/deep2essence/planet/blog/timedout_post
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/deep2essence/planet/blog/timedout_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
